...
import dev.fishies.routine.util.geometry.Radians.Companion.PI
import dev.fishies.routine.util.geometry.Radians.Companion.TAU
import dev.fishies.routine.util.math.umod
...
value class Radians(val radians: Double) : Comparable<Radians>, Formattable {
    ...
    companion object {
        ...
        /**
         * Half-pi constant in [dev.fishies.routine.util.geometry.Radians]
         */
        val HPI = kotlin.math.PI.radians * 0.5

        /**
         * Pi constant in [dev.fishies.routine.util.geometry.Radians]
         */
        val PI = kotlin.math.PI.radians

        /**
         * Tau (2pi) constant in [dev.fishies.routine.util.geometry.Radians]
         */
...
/**
 * @see dev.fishies.routine.util.math.umod
 */
